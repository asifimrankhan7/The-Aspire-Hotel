...
<body>
  ...
  <section class="facilities-section" id="services">
    <div class="rooms-header reveal">
      <span class="eyebrow">MODERN AND COMFORTABLE</span>
    ...
    $amenities = [
      [
        'icon' => 'ph-flower',
        'title' => 'Spa & Wellness',
        'desc' => 'Indulge in rejuvenating treatments and massages in a serene luxury environment.',
        'tag' => 'Open Daily'
      ],
      [
        'icon' => 'ph-fork-knife',
        'title' => 'The Grand Restaurant',
        'desc' => 'Savour global cuisines prepared by award-winning chefs in an intimate atmosphere.',
        'tag' => 'Fine Dining'
      ],
      [
        'icon' => 'ph-waves',
        'title' => 'Infinity Rooftop Pool',
        'desc' => 'Experience breathtaking city views from our temperature-controlled rooftop pool.',
        'tag' => 'Rooftop'
      ],
      [
        'icon' => 'ph-barbell',
        'title' => 'Fitness Center',
        'desc' => 'Stay active with state-of-the-art equipment designed for your daily workout needs.',
        'tag' => '24/7 Access'
      ],
      [
        'icon' => 'ph-bell-ringing',
        'title' => '24/7 Room Service',
        'desc' => 'Enjoy our curated menu delivered directly to your room at any hour of the day or night.',
        'tag' => 'At Your Service'
      ],
      [
        'icon' => 'ph-user-focus',
        'title' => 'Concierge Service',
        'desc' => 'Our dedicated staff is here to assist with tours, bookings, and personalised requests.',
        'tag' => 'Personalised'
      ],
      [
        'icon' => 'ph-presentation-chart',
        'title' => 'Conference Room',
        'desc' => 'Elegant spaces for corporate meetings, workshops, and high-profile business events.',
        'tag' => 'Business Ready'
      ],
      [
        'icon' => 'ph-car',
        'title' => 'Valet Parking',
        'desc' => 'Secure and convenient valet parking services for all our guests throughout their stay.',
        'tag' => 'Complimentary'
      ],
      [
        'icon' => 'ph-washing-machine',
        'title' => 'Laundry & Dry Cleaning',
        'desc' => 'Same-day laundry and dry cleaning services ensuring you always look your best.',
        'tag' => 'Express'
      ],
      [
        'icon' => 'ph-wifi-high',
        'title' => 'Complimentary Wi-Fi',
        'desc' => 'Stay connected with high-speed internet access available throughout the hotel premises.',
        'tag' => 'High Speed'
      ],
      [
        'icon' => 'ph-airplane-takeoff',
        'title' => 'Airport Shuttle',
        'desc' => 'Hassle-free transfers to and from the airport with our dedicated shuttle service.',
        'tag' => 'Upon Request'
      ],
      [
        'icon' => 'ph-martini',
        'title' => 'Mini Bar & Refreshments',
        'desc' => 'A well-stocked mini-bar in every room featuring a selection of drinks and snacks.',
        'tag' => 'In-Room'
      ],
    ];
    ?>
      ...
      <div class="facilities-grid reveal">
        <?php foreach ($amenities as $item): ?>
          <div class="amenity-card">
            ...
            <h3 class="amenity-title"><?= htmlspecialchars($item['title']) ?></h3>
            <p class="amenity-desc"><?= htmlspecialchars($item['desc']) ?></p>
            <div class="amenity-footer">
              <!-- <a href="#contact" class="amenity-link">Learn More &nbsp;→</a> -->
            </div>
          </div>
        <?php endforeach; ?>
      </div>
